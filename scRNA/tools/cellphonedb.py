...
def run_cellphonedb(
    ...
    if adata.raw is None:
        log.warning("adata.raw is not set. Using adata.X. It is highly recommended to use raw counts for CellPhoneDB.")
    ...
    try:
        ...
        raise FileNotFoundError("`cellphonedb` command not found. Please ensure CellPhoneDB is installed and in your PATH.")
