...
|----|----|----|----|----|
| QC | Reviewer-first filtering with sample-aware and tumor-aware guardrails | `run_standard_qc`, `run_qc_threshold_decision` | `qc_reviewer_table`, `qc_decision`, `qc_reason`, `qc_confidence`, `doublet_evidence_summary` | Stronger ambient/doublet calibration and real raw-matrix evidence |
