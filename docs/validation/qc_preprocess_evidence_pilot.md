...
- `validation_outputs/qc_evidence_package/qc_dataset_coverage.tsv`
...
- Consolidates threshold, tumor-aware, doublet, and ambient validation outputs
  into a single QC source-data table.
...
- Build plotting and visual QA around the stabilized QC source-data
  package and the preprocess source tables.
