<!-- AUTO-GENERATED: do not edit the inventory below manually.
     Generated by scripts/audit_public_api.py.
     Regenerate with: python scripts/audit_public_api.py --write
     Notes added above the AUTO-GENERATED markers are preserved across regenerations.
-->
