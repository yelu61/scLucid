...
def run_sccoda(
    ...
    Results are stored in adata.uns['scrnatk']['sccoda'][key_added].
    ...
    Args:
        ...
        key_added: Key under adata.uns['scrnatk']['sccoda'] for storing results.
    ...
    adata.uns.setdefault("scrnatk", {}).setdefault("sccoda", {})
    ...
    # Structured results
    adata.uns["scrnatk"]["sccoda"][key_added] = {
...
def summarize_sccoda(
    ...
    """
    sccoda = adata.uns.get("scrnatk", {}).get("sccoda", {}).get(key_added, {})
...
def plot_sccoda_proportion_with_significance(
    ...
    Args:
        adata: AnnData object with .obs and .uns['scrnatk']['sccoda'][sccoda_key] results.
        ...
        sccoda_key: Key in .uns['scrnatk']['sccoda'] for scCODA run.
    ...
    sccoda = adata.uns.get("scrnatk", {}).get("sccoda", {}).get(sccoda_key, {})
