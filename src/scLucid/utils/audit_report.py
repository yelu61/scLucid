...
def _render_module_section(
    *,
    ...
    if module == Modules.TUMOR and isinstance(review, Mapping):
        parts.append(_render_tumor_review_details(review))
...
def _iter_action_items(value: Any) -> list[Any]:
    """Return action items from in-memory lists or HDF5-safe mappings."""
