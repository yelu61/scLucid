...
class QCDashApp:
    ...
    def _setup_layout(self):
        ...
        self.app.layout = html.Div(
            [
                ...
                html.Div(
                    [
                        html.P("Generated by scLucid - Interactive QC Analysis", className="text-muted"),
                    ],
    ...
    def _setup_callbacks(self):
        ...
        def update_filter_preview(n_clicks, project_data, min_genes, max_mt, min_counts, project_id):
            ...
            try:
                ...
                stats_html = html.Div(
                    [
                        ...
                        html.P(f"Retained: {summary['retained']:,} ({summary['retained_pct']:.1f}%)"),
        ...
        @self.app.callback(
            ...
            [Input("violin-metric-dropdown", "value"),
             Input("project-id-input", "value")],
        )
        ...
        @self.app.callback(
            ...
            [Input("histogram-metric-dropdown", "value"),
             Input("project-id-input", "value")],
        )
        def update_histogram(metric, project_id):
            ...
            try:
                ...
                fig = go.Figure()
                fig.add_trace(
                    go.Bar(x=data["x"], y=data["y"], name=metric)
                )
